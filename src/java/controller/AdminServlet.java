...
/**
 * Servlet implementation class AdminServlet that can view user, food, surplus
 * food, and subscription lists within the admin dashboard. This servlet
 * supports actions like logging in as an admin, viewing users, foods, surplus
 * foods, and subscriptions.
 *
 * @author Zimeng Wang
 * @author Wenxin Li
 * @author Mengying Liu
...
public class AdminServlet extends HttpServlet {
    ...
    /**
     * Redirects HTTP GET requests to the doPost method. This method ensures
     * that both GET and POST requests are handled in the same manner.
     *
     ...
     * request URI. It extracts a method name from the URI and uses reflection
     * to call a corresponding method.
     *
     * @param request The servlet request.
     * @param response The servlet response.
     * @throws ServletException if a servlet-specific error occurs.
    ...
    /**
     * Processes login requests for the admin dashboard. It checks the
     * credentials against hardcoded values and redirects the user accordingly.
     *
     * @param request The servlet request.
     * @param response The servlet response.
     * @throws ServletException if a servlet-specific error occurs.
    ...
    /**
     * Retrieves all users from the database and forwards them to the admin user
     * management page.
     *
     * @param request The servlet request.
     * @param response The servlet response.
    ...
    /**
     * Retrieves all foods from the database and forwards them to the admin food
     * management page.
     *
     * @param request The servlet request.
     * @param response The servlet response.
    ...
    /**
     * Retrieves all surplus foods from the database and forwards them to the
     * admin surplus food management page.
     *
     * @param request The servlet request.
     * @param response The servlet response.
     * @throws ServletException if a servlet-specific error occurs.
    ...
    /**
     * Retrieves all subscriptions from the database and forwards them to the
