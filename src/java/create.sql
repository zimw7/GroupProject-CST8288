...
INSERT INTO SURPLUS_FOOD (NAME, QUANTITY, FOOD_TYPE, EXPIRATION_DATE, PRICE, DISCOUNT_RATE, USER_ID) VALUES
('Yogurt', 4, 'DAIRY', '2024-04-05', 1.75, 0.15, (SELECT ID FROM USERS WHERE USER_NAME = 'SOBEYS')),
('Apples', 10, 'PERISHABLE', '2024-04-02', 0.50, 0.20, (SELECT ID FROM USERS WHERE USER_NAME = 'SOBEYS')),
('Chicken', 5, 'PERISHABLE', '2024-03-30', 6.99, 0.10, (SELECT ID FROM USERS WHERE USER_NAME = 'target')),
('Bread', 3, 'CARBOHYDRATE', '2024-04-08', 1.99, 0.25, (SELECT ID FROM USERS WHERE USER_NAME = 'costco')),
('Rice', 8, 'CARBOHYDRATE', '2024-04-10', 4.50, 0.15, (SELECT ID FROM USERS WHERE USER_NAME = 'walmart')),
('Cheese', 3, 'DAIRY', '2024-04-15', 3.75, 0.20, (SELECT ID FROM USERS WHERE USER_NAME = 'walmart')),
('Oranges', 7, 'PERISHABLE', '2024-03-25', 0.60, 0.15, (SELECT ID FROM USERS WHERE USER_NAME = 'costco')),
('Beef', 6, 'PERISHABLE', '2024-03-28', 9.99, 0.10, (SELECT ID FROM USERS WHERE USER_NAME = 'target')),
('Cereal', 4, 'CARBOHYDRATE', '2024-04-05', 2.49, 0.25, (SELECT ID FROM USERS WHERE USER_NAME = 'walmart')),
('Apple Juice', 10, 'DRINK', '2024-04-12', 2.75, 0.20, (SELECT ID FROM USERS WHERE USER_NAME = 'target')),
('Peanut Butter', 5, 'CARBOHYDRATE', '2024-04-08', 3.99, 0.15, (SELECT ID FROM USERS WHERE USER_NAME = 'costco')),
('Tomatoes', 8, 'PERISHABLE', '2024-03-29', 1.25, 0.10, (SELECT ID FROM USERS WHERE USER_NAME = 'walmart'));

INSERT INTO SUBSCRIPTION (USER_ID, CONTACT_TYPE, PREFERENCE_TYPE) VALUES
((SELECT ID FROM USERS WHERE USER_NAME = 'JOE DOE'), 'TEXT', 'DAIRY'),
((SELECT ID FROM USERS WHERE USER_NAME = 'Alice Smith'), 'EMAIL', 'PERISHABLE'),
((SELECT ID FROM USERS WHERE USER_NAME = 'Bob Johnson'), 'TEXT', 'CARBOHYDRATE'),
((SELECT ID FROM USERS WHERE USER_NAME = 'RED CROSS'), 'EMAIL', 'DAIRY'),
((SELECT ID FROM USERS WHERE USER_NAME = 'Save The Children'), 'TEXT', 'PERISHABLE'),
((SELECT ID FROM USERS WHERE USER_NAME = 'World Vision'), 'EMAIL', 'DRINK');
